...
int *floorclip, *ceilingclip; // PSRAM-allocated

// spanstart holds the start of a plane span; initialized to 0 at start

static int *spanstart;                // PSRAM-allocated
...
fixed_t *yslope, *distscale; // PSRAM-allocated
...
void R_ClearPlanes(void)
{
  ...
  // Allocate cache arrays from PSRAM on first call (saves ~9.5KB DRAM)
  if (!cachedheight) {
    cachedheight = (fixed_t *)heap_caps_calloc(MAX_SCREENHEIGHT, sizeof(fixed_t), MALLOC_CAP_SPIRAM);
    cacheddistance = (fixed_t *)heap_caps_calloc(MAX_SCREENHEIGHT, sizeof(fixed_t), MALLOC_CAP_SPIRAM);
    cachedxstep = (fixed_t *)heap_caps_calloc(MAX_SCREENHEIGHT, sizeof(fixed_t), MALLOC_CAP_SPIRAM);
    cachedystep = (fixed_t *)heap_caps_calloc(MAX_SCREENHEIGHT, sizeof(fixed_t), MALLOC_CAP_SPIRAM);
    floorclip = (int *)heap_caps_calloc(MAX_SCREENWIDTH, sizeof(int), MALLOC_CAP_SPIRAM);
    ceilingclip = (int *)heap_caps_calloc(MAX_SCREENWIDTH, sizeof(int), MALLOC_CAP_SPIRAM);
    spanstart = (int *)heap_caps_calloc(MAX_SCREENHEIGHT, sizeof(int), MALLOC_CAP_SPIRAM);
    yslope = (fixed_t *)heap_caps_calloc(MAX_SCREENHEIGHT, sizeof(fixed_t), MALLOC_CAP_SPIRAM);
    distscale = (fixed_t *)heap_caps_calloc(MAX_SCREENWIDTH, sizeof(fixed_t), MALLOC_CAP_SPIRAM);
  }
